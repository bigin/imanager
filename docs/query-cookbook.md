...
sqlite3 data/imanager.db "EXPLAIN QUERY PLAN
  SELECT * FROM items WHERE field_active = 1;"
```

If you see `SCAN items` for a query you call often, the field
behind that predicate wants to be hot.
...
[`0001`–`0004`](api/storage.md#schemamanager) format.
